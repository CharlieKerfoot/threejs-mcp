...
material color and shading. MeshMatcapMaterial does not respond to lights since the matcap image file encodes
...
## Constructor
`newMeshMatcapMaterial( parameters :Object)`
...
- `.isMeshMatcapMaterial : boolean` — This flag can be used for type testing. Default is true .
